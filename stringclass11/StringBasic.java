...
public class StringBasic {
	...
	public static void main(String[] args) {
		...
		*/
		...
		strResult=  ac.equals(bc) ? "주소가 같다"  :"주소가 다르다"  ;//[o]
		System.out.println(strResult);
		...
		System.out.println("==로 주소 비교:"+(str1 == str2));//false
		//String클래스의 equals()메소드(Object로 부터 상속받은 메소드)
		//실제 저장된 문자열을 비교하도록 오버라이딩됨]
		System.out.println("equals()로 주소 비교:"+(str1.equals(str2)));//true
		...
		※String클래스에서 실제 저장된 문자열 비교시에는
		 ...
		 비교하도록 오버라이딩 해놓음
		 ※Object클래스의 equals()메소드는 원래 두 객체간의 
		   주소 비교를 하는 메소드임 		 
		 */
		String str5="Hello";
		String str6="HELLO";
		...
		System.out.println("equals()로 문자열 비교:"+(str5.equals(str6)));
		//[대소문자 구분하지 않고 비교-equalsIgnoreCase()메소드]
		System.out.println("equalsIgnoreCase()로 문자열 비교:"+(str5.equalsIgnoreCase(str6)));
		/*
