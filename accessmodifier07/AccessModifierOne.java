...
/*
접근지정자:클래스와 클래스 사이 혹은 클래스의 멤버간의 
                 접근을 제어하는 기능을 가진 한정자
...
class PackageClass{}//[o]생략형(패키지/디폴트) 접근 지정자가 붙은 클래스
...
public class AccessModifierOne {
	...
	public void publicMethod() {
		//다른 클래스에서 직접 호출이 불가능하니까(접근불가)
		//접근이 가능한 메소드에서 호출 
		privateMethod();
	}
	void packageMethod() {}
	private void privateMethod() {
		//private이 붙은 멤버는 자기 클래스안에서는
		//어디서든 접근 가능
		System.out.println("pprivateVar:"+privateVar);
	}
}
