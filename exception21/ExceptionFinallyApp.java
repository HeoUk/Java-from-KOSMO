	...
	/*
	   ...
	   1-2. 예외를 개발자가 직접 처리 try~catch절 이용
	    ...
	    try{
	  	...
	  	※main메소드에서는 런타임예외는 반드시 try~catch
...
//		}catch(IOException e) {}
	...
	static void tryCatchFinally() {
		...
		try {
			...
			System.exit(0);//바로 프로그램 종료.finally절 실행 안됨
		}
	...
	public static void main(String[] args) throws IOException /*throws NumberFormatException*/{
		...
		try {
			...
			System.out.println("숫자 형식이 아니예여:"+e.getMessage());
		}		
		tryCatchFinally();
		tryFinally();
