...
public class CharNBoolean {
	...
	public static void main(String[] args) {
		...
		char ch4_1 = 49;//숫자49는 아스키 코드값으로 처리됨.
		//위의 두 변수에는 같은 데이타가 저장됨 즉 문자 1
		...
		char ch6_2=0xAC00;
		char ch6_3='\uAC00';//''(싱글쿼테이션)안에서 AC00이 16진수라는 것을
							//나타내기 위해서 \\u를 추가한다.
		...
		int num3 = 48;
		int num4 = num3 - '0';//문자 0의 아스키코드값 48-48=0
